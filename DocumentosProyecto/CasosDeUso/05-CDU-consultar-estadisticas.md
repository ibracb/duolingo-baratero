...
2. El usuario pulsa el botón "Estadisticas".
3. El sistema calcula sus estadísticas.
4. El usuario accede a la [ventana de estadisticas](../Ventanas/VentanaEstadisticas.png).
