...
03. El usuario accede a la [ventana de configuración del curso](../Ventanas/VentanaConfiguracionCurso.png)
...
07. El sistema presentan las ventanas con las preguntas en el orden según la estrategia de aprendizaje seleccionada, ya sean [preguntas tipo test](../Ventanas/VentanaPreguntaTest.png), [preguntas de escucha](../Ventanas/VentanaPreguntaListen.png), [preguntas de selección de imagenes](../Ventanas/VentanaPreguntaImagenes.png) o [flashcards](../Ventanas/VentanaFlashcard.png).
...
**Postcondiciones:**  
01.  El sistema guarda el curso en los cursos en progreso del usuario.  
